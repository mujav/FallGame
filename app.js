...
start.onclick = function(){
    ...
    string = Pname + "'s score is : ";
      
    //stp.onclick = function(){ clearInterval(blocks); location.reload();}
    speedUP.onclick = function () {
        ...
        var blocks = setInterval( function(){
            ...
            var drop = 0;
            if (characterTop <= 0 ){
                alert("Game Over - " + Pname + "'s Score is " + (counter-9));
            ...
            for(var i = 0; i < currentBlocks.length; i++){
                ...
                score.innerHTML = string + (counter-9);
